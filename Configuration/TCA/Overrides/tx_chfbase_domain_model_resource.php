...
$GLOBALS['TCA']['tx_chfbase_domain_model_resource']['columns']['items']['config']['allowed'] .= ',tx_chfobject_domain_model_objectgroup,tx_chfobject_domain_model_singleobject';
